...
SECONDS=0
ZIPNAME="nethunter-avicii-$(date '+%Y%m%d-%H%M').zip"
...
AK3_DIR="AnyKernel3"
DEFCONFIG="avicii_defconfig"

MAKE_PARAMS="O=out ARCH=arm64 CC=aarch64-linux-gnu-gcc CLANG_TRIPLE=clang CROSS_COMPILE=aarch64-linux-gnu-"
...
MODULES_PATH="AnyKernel3/modules/vendor/lib/modules/${KERNEL_VERSION}-qgki+"
